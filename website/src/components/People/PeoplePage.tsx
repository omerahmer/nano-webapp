...
const people: PeopleData[] = [
  ...
  },
  {
    name: "Mateusz Czajka",
    image:
      '<a href="https://imgbb.com/"><img src="https://i.ibb.co/xXKBx3f/IMG-3956.jpg" alt="IMG-3956" border="0" /></a>',
...
const principalInvestigator = people.find(
  (person) => person.name === "Waqas Khalid",
);
const otherResearchers = people.filter(
  (person) => person.name !== "Waqas Khalid",
);
  ...
  return (
    <animated.div style={fadeIn} className="text-center font-link">
      <div className="container p-5 mx-auto">
        ...
        <p>
          Click <a href="/PeopleArchive">here</a> to view past interns.
        </p>
      </div>
    </animated.div>
  );

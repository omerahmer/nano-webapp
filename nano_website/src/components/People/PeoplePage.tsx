...
const sortedPeople: PeopleData[] = people.slice().sort((a, b) => {
    const lastNameA = a.name.split(' ').pop() || "";
    const lastNameB = b.name.split(' ').pop() || "";

    if (lastNameA === "Khalid") {
        return -1; // "Waqas Khalid" should come first
    } else if (lastNameB === "Khalid") {
        return 1; // "Waqas Khalid" should come first
    }
            ...
            <div className="container p-5 mx-auto">
                ...
                {sortedPeople.map((el) => (
                    <div key={el.name} className="row text-center mb-5">
                        ...
                        <div className="col-md-6">
                            <div className="people-image" dangerouslySetInnerHTML={{ __html: el.image }}></div>
                        </div>
                    </div>
                ))}
            </div>
